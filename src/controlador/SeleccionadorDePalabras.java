 ...
 * @author Mateo
 * 
 * Esta es la clase que contiene las palabras que se van a mostrar en Pantalla.
 * Contiene un arreglo con cada una de ellas y al final se define un método que selecciona un indice del arreglo
 * aleatoriamente y muestra la palabra que se encuentra en ese indice
 */
public class SeleccionadorDePalabras {

    //arreglo con la palabras que se van a mosrar
    private String[] palabras = new String[]{
        ...
        "paciente", "sociable", "colaborativo", "creativo", "apple", "banana", "car", "dog", "elephant", "flower", "guitar", "house", "internet", "jazz",
        ...
        "zealot"};
    //método que elige un indice al azar del arreglo y retorna la palabra que se encuentra en ese indice
